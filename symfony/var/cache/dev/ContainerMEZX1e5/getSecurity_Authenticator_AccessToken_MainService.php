...
class getSecurity_Authenticator_AccessToken_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.authenticator.access_token.main'] = $instance = new \Symfony\Component\Security\Http\Authenticator\AccessTokenAuthenticator(new \App\Security\AccessTokenHandler(($container->privates['App\\Repository\\LecteurRepository'] ?? $container->load('getLecteurRepositoryService'))), new \Symfony\Component\Security\Http\AccessToken\HeaderAccessTokenExtractor(), ($container->privates['security.user.provider.concrete.app_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUserProviderService')), NULL, NULL, NULL);

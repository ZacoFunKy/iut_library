 ...
 */
class getLecteurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LecteurRepository' shared autowired service.
     *
     * @return \App\Repository\LecteurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LecteurRepository.php';

        return $container->privates['App\\Repository\\LecteurRepository'] = new \App\Repository\LecteurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

 ...
 */
class getEditeurRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EditeurRepository.php';

        return $container->privates['App\\Repository\\EditeurRepository'] = new \App\Repository\EditeurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

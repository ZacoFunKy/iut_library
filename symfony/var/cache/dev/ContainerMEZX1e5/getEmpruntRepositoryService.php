 ...
 */
class getEmpruntRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmpruntRepository' shared autowired service.
     *
     * @return \App\Repository\EmpruntRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmpruntRepository.php';

        return $container->privates['App\\Repository\\EmpruntRepository'] = new \App\Repository\EmpruntRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}

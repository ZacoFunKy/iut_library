 ...
 */
class Editeur extends \App\Entity\Editeur implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'nomEditeur' => [parent::class, 'nomEditeur', null],
        'id' => [parent::class, 'id', null],
        'livres' => [parent::class, 'livres', null],
        'nomEditeur' => [parent::class, 'nomEditeur', null],
    ];
